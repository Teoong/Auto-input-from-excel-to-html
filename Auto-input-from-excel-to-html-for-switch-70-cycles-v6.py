...
print("=" * 60)
print("          70-CYCLE TARGETED COLUMN CONTROLLER (V3.5)")
print("       EMERGENCY CONTROLS: Slam mouse hard into any screen corner")
print("          🚫 NO ADMINISTRATOR PRIVILEGES REQUIRED")
print("=" * 60)

# Configure native PyAutoGUI Fail-Safe behaviors
pyautogui.FAILSAFE = True
# Microscopic pause between automation tasks to capture manual mouse-corner slams instantly
...
try:
    ...
    # --- BRIEF EMERGENCY STOP INSTRUCTIONS (ISSUES BEFORE COUNTDOWN) ---
    print("\n🆘 " + "!" * 20 + " EMERGENCY STOP PROTOCOL " + "!" * 20)
    print(" If the script goes out of alignment or types in the wrong window:")
    print(" JERK YOUR MOUSE FORCEFULLY INTO ANY CORNER OF YOUR MONITOR SCREEN.")
    print("\n      [Top-Left]  ======================  [Top-Right]     ")
    print("                  ||                  ||                  ")
    print("                  ||  SCREEN SURFACE  ||                  ")
    print("                  ||                  ||                  ")
    print("   [Bottom-Left]  ======================  [Bottom-Right]  ")
    print("\n Shoving your mouse physical pointer to coordinates (0,0) or your maximum")
    print(" display bounds will crash the script safely and instantly.")
    print("!" * 65)
    print("\nPress ENTER when you have read these instructions and are ready for the countdown...")
    input() # Pauses execution completely until user acknowledges the instruction
        
    print("\n⏳ Starting in 5 seconds! Immediately click back onto your web page field...")
    for countdown in range(5, 0, -1):
        print(f"   🚀 Commencing in {countdown}... (Throw mouse to corner to abort)")
        time.sleep(1)
    ...
    print("\n🛑 [EMERGENCY STOP] Mouse corner slam detected! Halting operations immediately...")
    print(f"⚠️ Process stopped mid-execution. Last active row processing: Excel Row {start_row + current_cycle}")
    print("=" * 60)
